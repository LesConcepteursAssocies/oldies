...
// ณ                                                                           ณ
// ณCalculs de CRC 16/32bits.                                                  ณ
// ิอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออพ

//
// Table des CRC 16 bits.
// (calculs par Mark G. Mendel, Network Systems Corporation)
//
static unsigned short tabcrc16[256] =
{
...
//
// Table des CRC 32 bits.
//
static unsigned int tabcrc32[] =
...
//
// Renvoi le CRC 16 bits mis … jour en fonction de l'octet donn.
//
unsigned short UpdateCRC16(unsigned char b,unsigned short crc16)
{
   return(tabcrc16[((crc16 >> 8) & 255)] ^ (crc16 << 8) ^ b);
}
//
// ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//
// Renvoi le CRC 32 bits mis … jour en fonction de l'octet donn.
//
unsigned int UpdateCRC32(unsigned char b,unsigned int crc32)
{
   return(tabcrc32[(unsigned char) (crc32 ^ (unsigned int) b)] ^ ((crc32 >> 8) & 0x00FFFFFF));
}
//
// ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
//
