...
#else
void *mem_fmalloc P((unsigned));
void *mem_fcalloc P((unsigned));
#define mem_ffree(p)	((void)0)
char *mem_fstrdup P((const char *));
#endif
#endif
...
char *mem_strdup_debug	P((const char *,const char *,int));
void *mem_calloc_debug	P((unsigned,const char *,int));
void *mem_malloc_debug	P((unsigned,const char *,int));
void *mem_realloc_debug P((void *,unsigned,const char *,int));
void  mem_free_debug	P((void *,const char *,int));
void  mem_freefp	P((void *));

void mem_setnewfileline P((void *,const char *,int));
